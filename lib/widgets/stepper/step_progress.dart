                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: widget.activeIndex > index ? colorScheme(context).surfaceDim : colorScheme(context).primaryContainer,
                      shape: BoxShape.circle,
                    ),
                    child: Center(
                      child: widget.activeIndex > index ?
                        Icon(Icons.check, color: colorScheme(context).onSurface, size: 16)
                        : Text((index + 1).toString(), style: TextStyle(color: _isDark ? ThemePalette.primaryLight : ThemePalette.primaryMain, fontWeight: FontWeight.bold))
                      ),
                  ),
                  Padding(
