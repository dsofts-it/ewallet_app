        ...
        child: Stack(children: [
          Positioned(
            ...
            child: IconButton(
              ...
              icon: Icon(Icons.close, color: colorScheme(context).outlineVariant)
            )
          ),
            ...
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(color: colorScheme(context).onSurface)
                ),
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  FaIcon(FontAwesomeIcons.apple, color: colorScheme(context).onSurface),
