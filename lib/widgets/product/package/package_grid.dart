...
class PackageGrid extends StatefulWidget {
  const PackageGrid({
    super.key,
  ...
  @override
  State<PackageGrid> createState() => _PackageGridState();
}

class _PackageGridState extends State<PackageGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.packageItems.isNotEmpty ? GridView.builder(
