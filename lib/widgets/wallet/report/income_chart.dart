      ...
      content: Column(
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(width: 4),
            Text('Income', style: ThemeText.subtitle2,),
          ]),
          Padding(
            padding: EdgeInsets.all(8),
            child: Text('The total amount(${userAccount.currencySymbol}) of your income in a week', style: ThemeText.caption, textAlign: TextAlign.center),
          ),
          Center(
            child: Padding(
