...
class RequestPersonalForm extends StatefulWidget {
  const RequestPersonalForm({super.key});

  @override
  State<RequestPersonalForm> createState() => _RequestPersonalFormState();
}

class _RequestPersonalFormState extends State<RequestPersonalForm> {
    ...
    return ListView(shrinkWrap: true, padding: EdgeInsets.all(spacingUnit(2)), children: [
      ...
      AppInputBox(
        ...
        content: ListTile(
          ...
          title: Text('Request to: ${recipient.name}', style: ThemeText.subtitle2,),
      ...
      AppInputBox(content: Column(children: [
        ...
        Padding(
          ...
          child: Text('Minimum Request is ${userAccount.currencySymbol}10', style: ThemeText.caption),
        ),
      ])),
      VSpaceShort(),
