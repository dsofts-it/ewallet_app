...
import 'package:ewallet_app/widgets/wallet/history/history_list.dart';
...
class _HistoryScreenState extends State<HistoryScreen> with RestorationMixin {
  ...
  List<Transaction> _filteredHistory = transactionList;
  ...
  void _onFilterHistory() async {
    ...
    List<Transaction> convertedList = _historyCtrl.filteredHistory.cast<Transaction>();
  ...
  void initState() {
    ...
    _historyCtrl.loadItems(transactionList);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        /// ITEMS
        Expanded(
          child: HistoryList(items: _filteredHistory)
        )
      ]),
    );
  }
