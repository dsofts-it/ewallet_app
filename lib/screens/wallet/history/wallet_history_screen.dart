...
import 'package:ewallet_app/widgets/wallet/history/wallet_history_list.dart';
...
class WalletHistoryScreen extends StatefulWidget {
  ...
  @override
  State<WalletHistoryScreen> createState() => _HistoryScreenState();
}

class _HistoryScreenState extends State<WalletHistoryScreen> with RestorationMixin {
  ...
  List<Transfer> _filteredHistory = transferList;
  ...
  void _onFilterHistory() async {
    ...
    List<Transfer> convertedList = _historyCtrl.filteredHistory.cast<Transfer>();
  ...
  void initState() {
    ...
    _historyCtrl.loadItems(transferList);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: HeaderFilter(
          selectedTitle: HistoryType.wallet,
          title: 'Transactions',
      ...
      body: Column(children: [
        ...
        /// ITEMS
        Expanded(
          child: WalletHistoryList(items: _filteredHistory)
        )
      ]),
    );
  }
