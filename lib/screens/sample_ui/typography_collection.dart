          ...
          children: [
            ...
            DecoratedBox(
              ...
              child: Padding(
                ...
                child: Text('Montserrat', textAlign: TextAlign.center, style: TextStyle(fontSize: 24, color: Colors.white),),
              )
            ),
            VSpaceShort(),
            DecoratedBox(
              ...
              child: Padding(
                padding: EdgeInsets.all(16),
                child: Text('Oxygen', textAlign: TextAlign.center, style: TextStyle(fontSize: 48, color: Colors.white),),
              )
            ),
            Divider(height: 50,),
